...
UsersAPI.get('/api/users', function (req, res) {
  User.all()
    .then(function (users) {
...
UsersAPI.get('/api/users/:username', function (req, res) {
...
UsersAPI.post('/api/users', function (req, res) {

  User.createIfNotExists( req.body )
  res.sendStatus(201)
})

UsersAPI.patch('/api/users', function (req, res) {
